...
const Pricing = () => {
  ...
  const onSubscribed = (plan) => {
    // terjadi logic untuk melakukan subscribe
    // pop up pembayaran
          ...
          <TableFooter>
            <TableRow>
              ...
              <TableCell align="center">
                <Button 
                variant="contained"
                onClick={() => onSubscribed("gold")}>Buy now</Button>
              </TableCell>
              <TableCell align="center">
                <Button 
                variant="contained"
                onClick={() => onSubscribed("platinum")}>Buy now</Button>
              </TableCell>
            </TableRow>
          </TableFooter>
        </Table>
